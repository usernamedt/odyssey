...
#define mm_yield machine_sleep(0);
	...
	MACHINE_API int64_t machine_create(char *name,
	                                   machine_coroutine_t,
	                                   void *arg);
	...
	MACHINE_API void machine_stat(uint64_t *coroutine_count,
	...
	MACHINE_API int64_t machine_coroutine_create(machine_coroutine_t,
	                                             void *arg);
	...
	MACHINE_API void machine_channel_write(machine_channel_t *,
	                                       machine_msg_t *);
...
MACHINE_API int machine_io_verify(machine_io_t *, char *common_name);
	...
	MACHINE_API int machine_getsockname(machine_io_t *,
	                                    struct sockaddr *,
	                                    int *);

	MACHINE_API int machine_getpeername(machine_io_t *,
	                                    struct sockaddr *,
	                                    int *);

	MACHINE_API int machine_getaddrinfo(char *addr,
	                                    char *service,
	...
	MACHINE_API int machine_connect(machine_io_t *,
	                                struct sockaddr *,
	                                uint32_t time_ms);
